        ...
        <div className="player-page">
            ...
            <div className="mt20 row">
                    ...
                    <div className="row mt20">
                        ...
                        <div className="volume-container">
                            ...
                            <div className="volume-wrapper">
                               <Progress progress={this.state.volume} onProgressChange={this.changeVolumeHandler} barColor="orange" />
                            </div>
                        </div>
                    </div>
                ...
                <div className="-col-auto cover">
                    ...
                    <img draggable="false" className={`rotate ${this.state.isPlay ? '':'isRotate'}`} src={this.props.currentMusicItem.cover} alt={this.props.currentMusicItem.title}/>
                    </div>
                </div>
            </div>
        </div>
